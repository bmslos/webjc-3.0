    ...
    def _find_plugin_class(self, module, plugin_name: str) -> Optional[Type]:
        ...
        for attr_name in dir(module):
            ...
            if isinstance(attr, type):
                if attr_name.lower().endswith(('detector', 'scanner')):
                    plugin_base_name = plugin_name.lower().replace('_', '')
                    class_base_name = attr_name.lower().replace('_', '')
                    if plugin_base_name in class_base_name or class_base_name in plugin_base_name:
                        return attr
